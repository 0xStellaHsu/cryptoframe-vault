  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // FHE Custom Colors
        crypto: {
          grid: "hsl(var(--crypto-grid))",
          blur: "hsl(var(--encrypted-blur))",
          vault: "hsl(var(--vault-gold))",
      ...
      animation: {
        ...
        "rotate-frame": "rotate-frame 20s linear infinite",
        "crypto-pulse": "crypto-pulse 3s ease-in-out infinite",
        "encrypted-blur": "encrypted-blur 4s ease-in-out infinite",
